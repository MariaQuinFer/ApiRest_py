...
books_by_title = Blueprint("books_by_title", __name__)

# Route to search by book title


@books_by_title.route("/books_by_title/<titulo>", methods=["GET"])
def read_booK_by_title(titulo):
